...
//     const { register, handleSubmit, control, reset, formState: { errors }, } = (0, react_hook_form_1.useForm)();
//     (0, react_1.useEffect)(() => {
//         if (id) {
//             fetchPost();
//         }
...
//             if (error)
//                 throw error;
//             if (data.author_id !== (user === null || user === void 0 ? void 0 : user.id)) {
//                 react_hot_toast_1.default.error('You can only edit your own posts');
//                 navigate('/dashboard');
//                 return;
//             }
//             reset({
...
//             react_hot_toast_1.default.error('Post not found');
//             navigate('/dashboard');
//         }
//         finally {
...
//             if (error)
//                 throw error;
//             react_hot_toast_1.default.success('Post updated successfully!');
//             navigate('/dashboard');
//         }
//         catch (error) {
//             console.error('Error updating post:', error);
//             react_hot_toast_1.default.error(error.message || 'Failed to update post');
//         }
//         finally {
//             setLoading(false);
//         }
